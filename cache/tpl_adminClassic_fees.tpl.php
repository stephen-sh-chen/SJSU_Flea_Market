...
<?php } ?>
					<table width="98%" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=setup_fee"><?php echo ((isset($this->_rootref['L_432'])) ? $this->_rootref['L_432'] : ((isset($MSG['432'])) ? $MSG['432'] : '{ L_432 }')); ?></a> </td>
						...
						<tr>
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=featured_fee"><?php echo ((isset($this->_rootref['L_433'])) ? $this->_rootref['L_433'] : ((isset($MSG['433'])) ? $MSG['433'] : '{ L_433 }')); ?></a> </td>
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=bold_fee"><?php echo ((isset($this->_rootref['L_439'])) ? $this->_rootref['L_439'] : ((isset($MSG['439'])) ? $MSG['439'] : '{ L_439 }')); ?></a> </td>
						</tr>
						<tr>
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=highlighted_fee"><?php echo ((isset($this->_rootref['L_434'])) ? $this->_rootref['L_434'] : ((isset($MSG['434'])) ? $MSG['434'] : '{ L_434 }')); ?></a> </td>
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=reserve_fee"><?php echo ((isset($this->_rootref['L_440'])) ? $this->_rootref['L_440'] : ((isset($MSG['440'])) ? $MSG['440'] : '{ L_440 }')); ?></a> </td>
						</tr>
						<tr>
							...
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=buynow_fee"><?php echo ((isset($this->_rootref['L_436'])) ? $this->_rootref['L_436'] : ((isset($MSG['436'])) ? $MSG['436'] : '{ L_436 }')); ?></a> </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/fees.php?type=extracat_fee"><?php echo ((isset($this->_rootref['L_804'])) ? $this->_rootref['L_804'] : ((isset($MSG['804'])) ? $MSG['804'] : '{ L_804 }')); ?></a></td>
						</tr>
					</table>
				</form>
			</div>
