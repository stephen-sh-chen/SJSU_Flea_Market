...
<?php if ($this->_rootref['UPDATE_AVAILABLE']) {  ?>
				<div class="alert alert-error"><?php echo ((isset($this->_rootref['L_30_0211'])) ? $this->_rootref['L_30_0211'] : ((isset($MSG['30_0211'])) ? $MSG['30_0211'] : '{ L_30_0211 }')); ?></div>
<?php } else { ?>
				<div class="alert alert-info"><?php echo ((isset($this->_rootref['L_30_0212'])) ? $this->_rootref['L_30_0212'] : ((isset($MSG['30_0212'])) ? $MSG['30_0212'] : '{ L_30_0212 }')); ?></div>
<?php } ?>
					...
					<tr>
						...
						<td>
							<form action="?action=clear_image_cache" method="post">
								<input type="hidden" name="csrftoken" value="<?php echo (isset($this->_rootref['_CSRFTOKEN'])) ? $this->_rootref['_CSRFTOKEN'] : ''; ?>">
								<input type="submit" name="submit" value="<?php echo ((isset($this->_rootref['L_30_0031a'])) ? $this->_rootref['L_30_0031a'] : ((isset($MSG['30_0031a'])) ? $MSG['30_0031a'] : '{ L_30_0031a }')); ?>">
							</form>
						</td>
					</tr>
					<tr>
