<div class="box">
					...
					<div class="rounded-bottom">
						<ul class="menu">
							...
							<li><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/analytics.php"><?php echo ((isset($this->_rootref['L_google_analytics'])) ? $this->_rootref['L_google_analytics'] : ((isset($MSG['google_analytics'])) ? $MSG['google_analytics'] : '{ L_google_analytics }')); ?></a></li>
						</ul>
					</div>
				</div>
				<div class="box">
