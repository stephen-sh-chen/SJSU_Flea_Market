...
<?php } ?>
				<form name="theme" action="" method="post">
					<table width="98%" cellpadding="0" cellspacing="0" class="blank">
					<th colspan="2"><?php echo ((isset($this->_rootref['L_NAY_03'])) ? $this->_rootref['L_NAY_03'] : ((isset($MSG['NAY_03'])) ? $MSG['NAY_03'] : '{ L_NAY_03 }')); ?></th>
	<?php $_themes_count = (isset($this->_tpldata['themes'])) ? sizeof($this->_tpldata['themes']) : 0;if ($_themes_count) {for ($_themes_i = 0; $_themes_i < $_themes_count; ++$_themes_i){$_themes_val = &$this->_tpldata['themes'][$_themes_i]; ?>
		...
		<?php } }} ?>
					...
					<table width="98%" cellpadding="0" cellspacing="0" class="blank">
						<th colspan="2"><?php echo ((isset($this->_rootref['L_NAY_04'])) ? $this->_rootref['L_NAY_04'] : ((isset($MSG['NAY_04'])) ? $MSG['NAY_04'] : '{ L_NAY_04 }')); ?></th>
	<?php $_admin_themes_count = (isset($this->_tpldata['admin_themes'])) ? sizeof($this->_tpldata['admin_themes']) : 0;if ($_admin_themes_count) {for ($_admin_themes_i = 0; $_admin_themes_i < $_admin_themes_count; ++$_admin_themes_i){$_admin_themes_val = &$this->_tpldata['admin_themes'][$_admin_themes_i]; ?>
						<tr <?php echo $_admin_themes_val['BG']; ?>>
							<td style="padding-left:10px;" width="75%">
							...
							<td align="left">
								<p><a href="theme.php?do=listfiles&theme=<?php echo $_admin_themes_val['NAME']; ?>"><?php echo ((isset($this->_rootref['L_26_0003'])) ? $this->_rootref['L_26_0003'] : ((isset($MSG['26_0003'])) ? $MSG['26_0003'] : '{ L_26_0003 }')); ?></a></p>
								<p><a href="theme.php?do=addfile&theme=<?php echo $_admin_themes_val['NAME']; ?>"><?php echo ((isset($this->_rootref['L_26_0004'])) ? $this->_rootref['L_26_0004'] : ((isset($MSG['26_0004'])) ? $MSG['26_0004'] : '{ L_26_0004 }')); ?></a></p>
							</td>
						</tr>
