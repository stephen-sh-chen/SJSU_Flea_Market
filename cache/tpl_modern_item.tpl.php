...
<?php if ($this->_rootref['B_HASIMAGE']) {  ?>
				<div class="main-gallery panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-12">
							<img class="img-rounded img-responsive center-block" src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>getthumb.php?w=<?php echo (isset($this->_rootref['THUMBWIDTH'])) ? $this->_rootref['THUMBWIDTH'] : ''; ?>&fromfile=<?php echo (isset($this->_rootref['PIC_URL'])) ? $this->_rootref['PIC_URL'] : ''; ?>" border="0" align="center" width="430px">
						</div>
