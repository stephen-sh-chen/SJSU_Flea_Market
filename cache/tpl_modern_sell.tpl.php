...
<?php } if ($this->_rootref['PAGE'] == 0) {  ?>
	...
	<?php } if ($this->_rootref['B_EDIT_STARTTIME']) {  ?>
		...
		<?php if ($this->_rootref['B_EDITING'] && (!B_CANEDITSTARTDATE)) {  ?>
	...
	<?php } ?>
				...
				<?php if ($this->_rootref['B_EDIT_ENDTIME']) {  ?>
								<?php echo ((isset($this->_rootref['L_or_custom_end_time'])) ? $this->_rootref['L_or_custom_end_time'] : ((isset($MSG['or_custom_end_time'])) ? $MSG['or_custom_end_time'] : '{ L_or_custom_end_time }')); ?>: <input type="text" name="a_ends" id="a_ends" value="<?php echo (isset($this->_rootref['END_TIME'])) ? $this->_rootref['END_TIME'] : ''; ?>" size="20" maxlength="19">
								<script type="text/javascript">
	...
	<?php } ?>
					...
					<div class="form-group col-md-12">
						...
						<div class="checkbox">
							<label><?php echo (isset($this->_rootref['PAYMENTS'])) ? $this->_rootref['PAYMENTS'] : ''; ?></label>
						</div>
					</div>
	...
	<?php } if ($this->_rootref['B_CAN_TAX']) {  ?>
					<div class="form-group col-md-12">
						...
						<div class="radio">
							<label class="radio-inline">
								<input type="radio" name="is_taxed" value="1" <?php echo (isset($this->_rootref['TAX_Y'])) ? $this->_rootref['TAX_Y'] : ''; ?>>	<?php echo ((isset($this->_rootref['L_030'])) ? $this->_rootref['L_030'] : ((isset($MSG['030'])) ? $MSG['030'] : '{ L_030 }')); ?>
							</label>
							<label class="radio-inline">
								<input type="radio" name="is_taxed" value="0" <?php echo (isset($this->_rootref['TAX_N'])) ? $this->_rootref['TAX_N'] : ''; ?>> <?php echo ((isset($this->_rootref['L_029'])) ? $this->_rootref['L_029'] : ((isset($MSG['029'])) ? $MSG['029'] : '{ L_029 }')); ?>
							</label>
						</div>
					</div>
					<div class="form-group col-md-12">
						...
						<div class="radio">
							<label class="radio-inline">
								<input type="radio" name="tax_included" value="1" <?php echo (isset($this->_rootref['TAXINC_Y'])) ? $this->_rootref['TAXINC_Y'] : ''; ?>>	<?php echo ((isset($this->_rootref['L_030'])) ? $this->_rootref['L_030'] : ((isset($MSG['030'])) ? $MSG['030'] : '{ L_030 }')); ?>
							</label>
							<label class="radio-inline">
								<input type="radio" name="tax_included" value="0" <?php echo (isset($this->_rootref['TAXINC_N'])) ? $this->_rootref['TAXINC_N'] : ''; ?>> <?php echo ((isset($this->_rootref['L_029'])) ? $this->_rootref['L_029'] : ((isset($MSG['029'])) ? $MSG['029'] : '{ L_029 }')); ?>
							</label>
						</div>
					</div>
	<?php } if ($this->_rootref['B_FEES']) {  ?>
