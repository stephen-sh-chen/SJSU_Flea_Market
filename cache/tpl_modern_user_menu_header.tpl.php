		...
		<div class="btn-group btn-group-justified visible-xs visible-sm" role="group" aria-label="...">
			<div class="btn-group" role="group">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="buysellnofeedback.php"><?php echo ((isset($this->_rootref['L_207'])) ? $this->_rootref['L_207'] : ((isset($MSG['207'])) ? $MSG['207'] : '{ L_207 }')); ?></a></li>
...
<?php } ?>
		...
		<div class="panel panel-default hidden-xs hidden-sm">
			<div class="list-group">
				...
				<a class="list-group-item" href="buysellnofeedback.php"><?php echo ((isset($this->_rootref['L_207'])) ? $this->_rootref['L_207'] : ((isset($MSG['207'])) ? $MSG['207'] : '{ L_207 }')); ?></a>
